...
require('code_runner').setup({
  ...
  filetype = {
    ...
    cpp = 'cd $dir && mkdir -p build && g++ -fsanitize=address -std=c++23 -g -DKEKIS -Wall -Wextra -Wshadow -Wno-sign-compare  -o ./build/$fileNameWithoutExt $fileName && ./build/$fileNameWithoutExt',
